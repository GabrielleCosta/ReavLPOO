...
public class ImobiliariaController {
    public static void main(String[] args) {
        ...
        //G
        System.out.println(" \n ******** Exercicio G ******** \n ");
        double estimativaPorUnidade = 0.0;
        for (Portfolio item : Portfolio) {
            if (item instanceof Imobiliaria) {
                Imobiliaria imobiliaria = (Imobiliaria) item;
                estimativaPorUnidade = (imobiliaria.getPrevisaoDeFaturamento() * imobiliaria.getITBI()) / 100;
                System.out.println("Cotação " + imobiliaria.getPrevisaoDeFaturamento() + "  e taxa de porcentagem do ITBI: "
                        + imobiliaria.getITBI() + " tem estimativa de ITBI total: " + estimativaPorUnidade);
            }
        }
